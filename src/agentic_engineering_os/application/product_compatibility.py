...
ARTIFACT_CONTRACTS = (
    ...
    CompatibilityArtifactContract(CompatibilityArtifact.GITIGNORE_MANAGED_SECTION, "2", ".gitignore", "managed text / Git-tracked", "SYSTEM_INVARIANT", ArtifactRequirement.REQUIRED, MigrationArtifact.GITIGNORE_MANAGED_SECTION),
